Vagrant.configure("2") do |config|
    ...
    #     vue.vm.hostname = "vue"
    #     vue.vm.network "private_network", ip: "192.168.56.16", adapter: 2, type: "static", virtualbox__intnet: false
    #     vue.vm.provider "virtualbox" do |vb|
    #         vb.memory = 2048
    #         vb.cpus = 2
    #     end
    # end
    ...
    config.vm.provision "ansible" do |ansible|
        ...
        ansible.groups = {
            ...
            "all_nodes:children" => ["database", "webserver", "loadbalancer", "frontend", "backend"]
        }
        ansible.limit = "all" 
        ansible.verbose = "v"
    end
